...
- Coverage Assessment (s1, s2)

. . .

Sensitivity Analysis

- Use five different sets of priors (i.e., fix one parameter, and vary the other with informative, diffuse or shifted prior) [^sensitivity] and check for convergence. 
