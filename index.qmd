...
[^res]: Dashed (black) lines are true weights or dependence, dot-dashed (red) lines are prior means, solid (blue) lines are posterior means, and polygons are $95\%$ posterior credible intervals. 
...
![Asterisk (*) denotes modification of Zheng's (2010) algorithm.](images/alg-1.png){fig-align="left"}
