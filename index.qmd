...
The bivariate distribution approach, e.g., 
...
We are not gonna discuss them here [^sen].
...
- Current models utilize Gaussian copula. Future work should include alternative copulas, like Clayton and Gumbel, to capture tail dependence and asymmetry. 

- Current models use Gamma marginals and their ZI version. Future work could incorporate Beta, Lognormal, and Weibull distributions and their ZI versions to accommodate diverse data characteristics and applications. 
...
- Given the growing prominence of transformers in sequence modeling, further research should extend performance comparisons to include transformer-based models [^transformer]. 
