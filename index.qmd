...
- Wind speed forecasting is a challenging time series problem.

  - Strong temporal dependence and skewed distribution, which can pose challengings for standard deep learning approaches. 

. . . 

- Accurate wind speed forecasting is important for reliable power generation. 
...
- Derived wind speeds from the $U$ and $V$ wind components. 

- Hourly wind speeds (m/s) at 2 m, 10 m, and 50 m above ground level at the Limon Wind Energy Center from 2024-2025. 

. . . 

Train/Test Split

- Used an 80/20 chronological split, with the first $80%$ of observations used for training and the final $20%$ used for testing in order to preserve the temporal ordering. 

. . . 

LSTM Preprocessing 

- Applied min-max scaling for input features and labels, and inverse-transformed predictions back to the original scale. 
...
- For MTD, the hyperparameter settings were:
...
- For LSTM, the configurations selected based on the literature and our experiments were: 
