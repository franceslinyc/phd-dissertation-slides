...
. . .
  ...
  - Copula is a multivariate cumulative distribution function (cdf) with $\text{Unif}(0, 1)$ marginals. 

. . .

  - Using copula, any joint distribution, $F$, can be decomposed into two parts: a copula, $C$, and the marginals, $F_j$, $j = 1,..., p$. 
...
- Recall that we have six $P \times \epsilon$ cases per scenario.
...
Beyond natural language processing (NLP), they have also shown effective in time series forecasting and 
