...
Our approach is similar to hurdle models, where zeros occur only in the binary part. 
...
## Coverage Assessment for Scenario 1 and 2, 40 Replicates [^coveragezigamma]
