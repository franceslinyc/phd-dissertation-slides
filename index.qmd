...
> Evaluate the proposed models against the Long Short-Term Memory (LSTM) networks, demonstrating higher predictive accuracy, while providing uncertainty quantification and interpretability. 
...
- Extend the autoregressive (AR) models to accommodate non-Gaussian and nonlinear features [^nonlinear]. 
...
> Demonstrate that our proposed MTDs outperform LSTMs in accuracy, with UE and interpretability, though at higher computational cost and with more involved model design. 
