...
- Produce accurate forecasts while appropriately capturing temporal dependence and skewness. 

. . . 

Approach 

- Compare MTD and LSTM models for wind speed forecasting and evaluate how well they capture the temporal and distributional characteristics of data. 
...
. . . 
  ...
  - Limitation: The current MTD formulation does not support additional predictors, so we did not include external predictors in either model. 
...
- Explicitly models marginal distribution and temporal dependence
...
- MTD is implemented in `R` and `C++` and compiled and executed on a high-performance computing (HPC) cluster. 
