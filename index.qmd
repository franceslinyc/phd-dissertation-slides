...
- Has also demonstrated success in modeling spatial data. 
...
- LSTM is typically trained using Backpropagation Through Time (BPTT) and optimized with gradient-based methods such as Adam.
...
## Trace and Density Plot for Scenario 1’s $w$
...
## Trace and Density Plot for Scenario 1’s $\rho$
...
## Trace and Density Plot for Scenario 1's $\mu, \beta, P, \epsilon$
