...
Wind speed exhibits a highly skewed distribution with strong temporal dependence. 

- Accurate forecasting of wind speed is crucial for reliable power generation. 

. . . 

NASA MERRA-2 data

- Accessed via the NASA GES DISC Earthdata API and processed to derive wind speeds from wind components at multiple heights.

. . . 

Datasets 

- Hourly wind speeds (m/s) at 2 m, 10 m, and 50 m above ground level at the Limon Wind Energy Center in 2024-2025.
...
- Based on the sensitivity analysis, we use the following LSTM configuration: 
