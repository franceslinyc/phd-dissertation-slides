...
- Although the current framework assumes stationarity and does not incorporate predictors, it can be readily extended with additional terms in the conditional mean structure to capture more complex temporal patterns. 
