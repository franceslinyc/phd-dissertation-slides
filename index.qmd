...
- We consider the Gaussian copula with Gamma marginals, i.e., Gamma MTD model, but the framework is generalizable, e.g., 
  ...
  - Lognormal or any continuous distribution. 

  - Clayton or any other copula. 
...
- Generate $n = 2000$ observations from the copula-based ZIGamma MTD model.
...
- Empirical coverage is relevant only for probabilistic forecasting methods such as MTD.
