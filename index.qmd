...
Wind speed is a key proxy variable in energy forecasting.
...
- were accessed from the NASA GES DISC Earthdata API.

- Wind speed components at multiple heights for the Limon Wind Energy Center were further processed. 

. . . 

The datasets used are

- hourly wind speeds (m/s) at heights of 50m above ground level

- hourly wind speeds (m/s) at heights of 10m above ground level

- hourly wind speeds (m/s) at heights of 2m above ground level
